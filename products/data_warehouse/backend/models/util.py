...
CLICKHOUSE_HOGQL_MAPPING = {
    "posthog.UUID": StringDatabaseField,
    "posthog.String": StringDatabaseField,
    "posthog.Nothing": UnknownDatabaseField,
    "DateTime64": DateTimeDatabaseField,
    "DateTime32": DateTimeDatabaseField,
    "posthog.DateTime": DateTimeDatabaseField,
    "posthog.Date": DateDatabaseField,
    ...
    "posthog.Tuple": StringJSONDatabaseField,
    "posthog.Array": StringArrayDatabaseField,
    "posthog.Map": StringJSONDatabaseField,
    "posthog.Bool": BooleanDatabaseField,
    "posthog.Decimal": DecimalDatabaseField,
    "posthog.FixedString": StringDatabaseField,
}

STR_TO_HOGQL_MAPPING = {
    "posthog.BooleanDatabaseField": BooleanDatabaseField,
    "posthog.DateDatabaseField": DateDatabaseField,
    "posthog.DateTimeDatabaseField": DateTimeDatabaseField,
    "posthog.IntegerDatabaseField": IntegerDatabaseField,
    "posthog.DecimalDatabaseField": DecimalDatabaseField,
    "posthog.FloatDatabaseField": FloatDatabaseField,
    "posthog.StringArrayDatabaseField": StringArrayDatabaseField,
    "posthog.StringDatabaseField": StringDatabaseField,
    "posthog.StringJSONDatabaseField": StringJSONDatabaseField,
    "posthog.UnknownDatabaseField": UnknownDatabaseField,
}
